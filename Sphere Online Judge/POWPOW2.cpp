...
int mod[] = {2,41 * 41,148721};int rem[3];long long fact1[200001],fact2[148721];
...
int main()
{
    ...
    int p = 2,q = 500000003; // 500000004 is inverse of 2
    int invq = 1,invp = 250000002; // inverse of 4
    int T,a,b,n;
